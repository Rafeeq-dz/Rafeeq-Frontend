// src/pages/dashboard/my-learning/courses/index.tsx
                                ...
                                <tr key={course.id} className="border-t">
                                    <td className="p-3">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground hidden md:block">{course.description}</p>
                                        </div>
                                    </td>
                                    <td className="p-3 hidden md:table-cell">{course.teacher}</td>
                                    <td className="p-3 hidden lg:table-cell">{course.students} students</td>
                                    <td className="p-3">{new Date(course.lastActive).toLocaleDateString()}</td>
    ...
    return (
        <div className="border rounded-lg overflow-hidden bg-card hover:border-primary/50 transition-colors">
            <div className="h-32 bg-gradient-to-r from-primary/20 to-primary/5 flex items-center justify-center">
                <h3 className="text-xl font-bold text-center px-4">{course.name}</h3>
            </div>
